 ...
 *
 *
 * A [org.bitcoinj.store.FullPrunedBlockStore] is an internal implementation within bitcoinj.
 */
interface UTXOProvider {
    ...
    /**
     * Get the list of [UTXO]'s for a given address.
     * @param addresses List of address.
     * @return The list of transaction outputs.
     * @throws UTXOProviderException If there is an error.
     */
    @Throws(UTXOProviderException::class)
    fun getOpenTransactionOutputs(addresses: List<Address>): List<UTXO>
}

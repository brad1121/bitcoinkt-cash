...
interface ReorganizeListener {
    ...
    /**
     * Called by the [org.bitcoinj.core.BlockChain] when the best chain
    ...
    fun reorganize(splitPoint: StoredBlock, oldBlocks: List<StoredBlock>,
                   newBlocks: List<StoredBlock>)
}

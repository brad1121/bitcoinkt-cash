...
interface TransactionConfidenceEventListener {
     ...
     *
     *
     * You should pay attention to this callback in case a transaction becomes *dead*, that is, a transaction
     ...
     *  1. Somebody is attacking the network and reversing transactions, ie, the user is a victim of fraud.
     *  1. A bug: for example you create a transaction, broadcast it but fail to commit it. The [Wallet]
